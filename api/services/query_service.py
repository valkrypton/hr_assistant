...
def resolve_scope(body: QueryRequest) -> RBACContext | None:
...
def run_agent(query: str, rbac_ctx: RBACContext | None) -> QueryResult:
    ...
    return agent_query(query, rbac_ctx=rbac_ctx)
